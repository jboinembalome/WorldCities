...
using WorldCities.Application.Features.Boards.Queries.GetBoardsByUserId;
...
namespace WorldCities.Application.UnitTests.Features.Boards.Queries
{
    public class GetBoardsByUserIdQueryHandlerTests
    {
        ...
        public async Task GetBoardsByUserIdTest_ExistingUserId_ReturnsBoards()
        {
            ...
            var getBoardsByUserIdQuery = new GetCitiesQuery { UserId = "2cd08f87-33a6-4cbc-a0de-71d428986b85" };
        ...
        public async Task GetBoardsByUserIdTest_NoExistingUserId_ReturnsZeroBoard()
        {
            // Arrange
            var handler = new GetBoardsByUserIdQueryHandler(_mapper, _mockBoardRepository.Object);
            var getBoardsByUserIdQuery = new GetCitiesQuery { UserId = "3cd08f87-33a6-4cbc-a0de-71d428986b85" };
