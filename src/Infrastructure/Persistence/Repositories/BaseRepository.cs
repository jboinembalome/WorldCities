...
namespace WorldCities.Infrastructure.Persistence.Repositories
{
    public class BaseRepository<T, TId> : IAsyncRepository<T,TId> where T : class, Domain.Interfaces.IEntity<TId>
    {
        protected readonly WorldCitiesDbContext _dbContext;
        private readonly ISpecificationEvaluator _specificationEvaluator;

        public BaseRepository(WorldCitiesDbContext dbContext)
        {
