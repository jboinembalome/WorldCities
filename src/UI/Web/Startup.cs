...
using WorldCities.Web.Filters;
using WorldCities.Web.Services;
using System;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHealthChecks()
                .AddDbContextCheck<WorldCitiesDbContext>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "WorldCities API");
            });
        ...
        private static void AddSwagger(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "WorldCities API",
                    Description = "API for accessing WorldCities project data.",
